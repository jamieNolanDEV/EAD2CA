...
public class BMITestWithCat {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void bMITestWithCat() {
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.weight),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("130"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.bmi), withText("76.92"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("76.92")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.bmicat), withText("Severely Obese"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.RelativeLayout.class),
                                        1),
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("Severely Obese")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.bmicat), withText("Severely Obese"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("Severely Obese")));
    }
